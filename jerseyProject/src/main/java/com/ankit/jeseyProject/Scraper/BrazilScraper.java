...
public class BrazilScraper 
{
	...
	public List<Currency> getCurrencyScraper() throws IOException
	{
		...
		try 
		{
			...
			doc = Jsoup.connect("https://www.bundesbank.de/dynamic/action/de/statistiken/zeitreihen-datenbanken/zeitreihen-datenbank/723452/723452?tsId=BBEX3.D.BRL.EUR.BB.AC.000&tsTab=0&dateSelect="+ URLEncoder.encode(searchQuery, "UTF-8")).get();
